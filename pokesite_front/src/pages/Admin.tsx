    ...
    useEffect(() => {
        ...
        const fetchLogs = async () => {
            try {
                ...
                const url = "http://localhost:8000/api"; // On utilise une URL fixe pour éviter les problèmes de dépendances et pour s'assurer que la fonction n'est pas recréée à chaque rendu.
